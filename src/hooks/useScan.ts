  ...
  switch (event.type) {
    ...
    case "complete": {
      ...
      return {
        ...
        representativeUrls: r.representativeUrls,
        scrapedUrls: r.scrapedUrls,
        unscannedPages: r.unscannedPages,
  ...
  switch (event.type) {
    ...
    case "complete":
      setScan({
        ...
        sitemapUrls: event.result.sitemapUrls,
        representativeUrls: event.result.representativeUrls,
        scrapedUrls: event.result.scrapedUrls,
        unscannedPages: event.result.unscannedPages,
